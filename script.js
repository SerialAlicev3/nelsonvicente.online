const translations = {
  pt: {
    ...
    linkedinText: "Perfil profissional e ligacao direta",
  ...
  en: {
    ...
    linkedinText: "Professional profile and direct connection",
